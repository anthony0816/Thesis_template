...
\begin{figure}[H]
    \centering
    \captionbox{Diagrama de Casos de Uso General del Sistema\label{fig:casos_uso_sistema}}
...
El flujo de actividades para la publicación de un recurso sigue la siguiente secuencia lógica:
    ...
    \begin{figure}[H]
        \centering
        \captionbox{Diagrama de Actividad del Proceso de Subida de Assets\label{fig:casos_uso_sistema}}
        {\includegraphics[width=0.7\linewidth]{Images/diagramas/DA_subida_de_asset.JPG}}
    \end{figure}
...
% searchthis
    \begin{figure}[H]
        \centering
        \captionbox{ Diagrama Entidad-Relación (DER)\label{fig:casos_uso_sistema}}
        {\includegraphics[width=0.7\linewidth]{Images/diagramas/ED_modelo_entidad_relacion.PNG}}
    \end{figure}
...
% searchthis
    \begin{figure}[H]
        \centering
        \captionbox{Interfaz de la Página Principal y Galería de Assets\label{fig:casos_uso_sistema}}
...
% searchthis
    \begin{figure}[H]
        \centering
        \captionbox{Interfaz de Detalle de Asset con Comentarios y Opciones\label{fig:casos_uso_sistema}}
...
% searchthis
    \begin{figure}[H]
        \centering
        \captionbox{DInterfaz de Generación de Assets mediante IA\label{fig:casos_uso_sistema}}
